...
plt.text(-15, -2, r'$y='+ str(round(a[0],3)) +' x + ' + str(round(b[0],3)) +'$' , horizontalalignment='left',fontsize=32)
plt.text(-15, -3, r'$r^{2} = ' + str(round(c,3)) +'$' , horizontalalignment='left',fontsize=32)
...
plt.title('CHNOPSFClNaKMgCa500 HOMO')
...
ax.set_title("CHNOPSFClNaKMgCa500 HOMO",y=1.0, pad=-30)
