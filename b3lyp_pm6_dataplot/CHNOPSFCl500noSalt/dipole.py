...
plt.text(0, 55, r'$y='+ str(round(a[0],3)) +' x' + str(round(b[0],3)) +'$' , horizontalalignment='left',fontsize=32)
plt.text(0, 50, r'$r^{2} = ' + str(round(c,3)) +'$' , horizontalalignment='left',fontsize=32)
...
plt.title('CHNOPSFCl500 dipole moment')
...
ax.set_title("CHNOPSFCl500 dipole moment",y=1.0, pad=-30)
