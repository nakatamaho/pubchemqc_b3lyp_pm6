...
plt.text(0, 45, r'$y='+ str(round(a[0],3)) +' x' + str(round(b[0],3)) +'$' , horizontalalignment='left',fontsize=32)
plt.text(0, 40, r'$r^{2} = ' + str(round(c,3)) +'$' , horizontalalignment='left',fontsize=32)
...
plt.title('CHON500 dipole moment')
...
ax.set_title("CHON500 dipole moment",y=1.0, pad=-30)
