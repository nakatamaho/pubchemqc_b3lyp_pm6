...
plt.text(-5, 5, r'$y='+ str(round(a[0],3)) +' x ' + str(round(b[0],3)) +'$' , horizontalalignment='left',fontsize=32)
plt.text(-5, 3.5, r'$r^{2} = ' + str(round(c,3)) +'$' , horizontalalignment='left',fontsize=32)
...
plt.title('PubChemQC B3LYP/6-31G*//PM6 LUMO')
...
ax.set_title("PubChemQC B3LYP/6-31G*//PM6 LUMO",y=1.0, pad=-30)
