...
print("cid,formula,cansmi,b3lyp_pm6_gap,b3lyp_pm6_homo,b3lyp_pm6_lumo,b3lyp_pm6_dipole,totalenergy,mw");
with open(sys.argv[1]) as fin:
    for line in fin:
        ...
        print( str(data['cid']) + "," 
             ...
             + str(data['data']['pubchem']['B3LYP@PM6']['properties']['energy']['total']) + "," 
             + str(data['data']['pubchem']['molecular weight'])
             )
