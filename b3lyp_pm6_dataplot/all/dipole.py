...
plt.title('PubChemQC B3LYP/6-31G*//PM6 dipole moment', fontsize=25, pad=15)
...
ax.set_title("PubChemQC B3LYP/6-31G*//PM6 dipole moment",y=1.0, pad=-20,fontsize=25)
ax.set_xlabel("Dipole moment by PM6//PM6 in debye", fontsize=15, labelpad=30)
ax.set_ylabel("Dipole moment by B3LYP/6-31G*//PM6 in debye", fontsize=14, labelpad=30)
