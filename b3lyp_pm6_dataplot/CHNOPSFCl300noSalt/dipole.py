...
plt.text(0, 35, r'$y='+ str(round(a[0],3)) +' x' + str(round(b[0],3)) +'$' , horizontalalignment='left',fontsize=32)
plt.text(0, 30, r'$r^{2} = ' + str(round(c,3)) +'$' , horizontalalignment='left',fontsize=32)
...
plt.title('CHNOPSFCl300 dipole moment')
...
ax.set_title("CHNOPSFCl300 dipole moment",y=1.0, pad=-30)
